import { CommentsRepositorySub } from '../../stubs/data/CommentsRepositorySub'
import {
    CommandCommentController
} from '../../../src/domain/command-comment/CommandCommentController'
...
test('cancels wrong commands', async () => {
    ...
    expect(commentsRepositoryStub.editComment).toBeCalledWith(
        ...
        CommandCommentFactory.createComment(
            ...
            'friday merge',
            CommandStatus.CANCELLED,
            'Only @max have rights to execute commands'
        ).body
    )
})
