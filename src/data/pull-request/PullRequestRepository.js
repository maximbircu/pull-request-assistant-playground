...
export class PullRequestRepository {
    ...
    async getPullRequest(prNumber) {
        ...
        this.#logger.debugCollapsibleObject('Octokit Response - Get Pull Request', response)
    ...
    async getChecks(pullRequest) {
        ...
        this.#logger.debugCollapsibleObject('Octokit Response - Get Checks', response)
    ...
    async merge(pullRequest, mergeMethod, commitMessage) {
        ...
        this.#logger.debugCollapsibleObject('Octokit Response - Merge Pull Request', response)
    ...
    async getReviews(pullRequestNumber) {
        ...
        this.#logger.debugCollapsibleObject('Octokit Response - Get Reviews', response)
    ...
    async getCommits(pullRequestNumber) {
        ...
        this.#logger.debugCollapsibleObject('Octokit Response - Get Commits', response)
